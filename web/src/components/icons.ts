...
/**
 * Shared SVG icon library — lucide-style, 24x24 viewBox, stroke icons.
 */
...
const PATHS: Record<string, string> = {
  ...
  'message-question': '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>',
  ...
  'panel-left-close': '<rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" y1="3" x2="9" y2="21"/><polyline points="15 9 12 12 15 15"/>',
}

export function svgIcon(name: string, size = 16) {
  const paths = PATHS[name]
  if (!paths) return html``
  return html`<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${unsafeSVG(paths)}</svg>`
}
