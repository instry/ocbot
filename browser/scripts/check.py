...
def check_environment(args):
    ...
    if depot_available and free_gb > 100:
        print("Recommendation: Full Development Setup")
        print("")
        print("Reason:")
        print("  depot_tools installed")
        ...
        print("")
        print("Run commands:")
        print("  python ocbot/scripts/dev.py init --no-history")
        print("  python ocbot/scripts/dev.py worktree create")

    elif free_gb > 60:
        print("Recommendation: Install depot_tools first")
        print("")
        print("Reason:")
        print(f"  Sufficient disk space ({free_gb}GB > 60GB)")
        if not depot_available:
            print("  depot_tools not installed (required)")
        print("")
        print("After installing depot_tools, run:")
        print("  python ocbot/scripts/dev.py init --no-history")
        print("  python ocbot/scripts/dev.py worktree create")

    else:
        print("Disk space might be insufficient")
        print("")
        print(f"Current available: {free_gb}GB")
        print("Suggested at least: 100GB")
        print("")
    ...
    print("")
    print("Get help:")
    print("  python ocbot/scripts/dev.py init --help")
    print("  python ocbot/scripts/dev.py worktree --help")
    print("")
